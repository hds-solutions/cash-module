...
mix.options({
    fileLoaderDirs: {
        images: 'cash-module/assets/images',
        fonts: 'cash-module/assets/fonts',
    }
});
...
mix
     ...
     ** *********************** **/
    .js('resources/assets/js/app.js',       'cash-module/assets/js')
    .sass('resources/assets/sass/app.scss', 'cash-module/assets/css')
    .copy('resources/assets/images',        public+'/cash-module/assets/images')
